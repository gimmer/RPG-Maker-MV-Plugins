...
Imported['Gimmer_NoSpoilersMenu'] = '1.2'
 ...
 * - Version 1.2: Removed MP from character status menu
 *
 * Terms of Use:
 * =======================================================================
...
Gimmer_Core.NSM.Window_Base_prototype_drawActorMp = Window_Base.prototype.drawActorMp;
Window_Base.prototype.drawActorMp = function(actor, x, y, width){
    ...
    if(skills.length === 0){
        ...
        Gimmer_Core.NSM.Window_Base_prototype_drawActorMp.call(this, actor, x, y, width);
    }
}
