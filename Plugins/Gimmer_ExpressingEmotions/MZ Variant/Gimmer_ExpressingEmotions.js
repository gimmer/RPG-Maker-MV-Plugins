 ...
 * @help
 * ======================
 * Gimmer_ExpressingEmotions MZ Version
 * ======================
 *
...
Window_Base.prototype.flushTextState = function(textState) {
    if(this.isEmotionalText()) {
        ...
        const y = textState.y;
        this.createEmotionalString(textState, text, width, height);
        textState.x += width;
        ...
        Gimmer_Core.ExpressingEmotions._Window_Base_prototype_flushTextState.call(this, textState);
    }
}
