 ...
 * @author Gimmer
 * @help This plugin lets you use the plugin command ShowPicture as an alternative to regular show picture in an event or common event.
 * The syntax is ShowPicture ID Filename X Y Scale-W Scale-H BlendOpacity BlendMode
 *
 * Accepted formats:
 ...
 *
 * But Gimmer, I hear you say: I don't want to use a plugin command! I want to just load images in the editor through "Show Picture" in the menu.
